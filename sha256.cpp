...
uint32_t right_shift(uint32_t x, uint32_t n) { return x >> n; }
...
void sha256_final(SHA256_ctx *ctx, uint8_t hash[]) {
  ...
  // append total length of message
  ...
  // convert big indian to little endian
  for (i = 0; i < 4; i++) {
